...
const StorageClassRow: React.SFC<StorageClassRowProps> = ({obj}) => {
  return <div className="row co-resource-list__item">
    <div className="col-sm-5 col-xs-6 co-break-word">
      <ResourceLink inline={true} kind={StorageClassReference} name={obj.metadata.name} namespace={undefined} title={obj.metadata.name} />
      { isDefaultClass(obj).toString() ? <i><small className="text-muted"> &ndash; &nbsp; &nbsp; Default </small></i> : null }
    </div>
    <div className="col-sm-5 col-xs-6 co-break-word">
      {obj.provisioner}
    </div>
